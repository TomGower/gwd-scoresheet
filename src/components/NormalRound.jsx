...
const DisplayRound = ({round, updater, answers, scores}) => {
  ...
  return (
    <div>
      ...
      <span style={{color: holder.q1}}>Answer</span>: <input className='answer' id={`round${round}answer q1`} defaultValue={answers[0]}></input><input type="checkbox" id={`round${round} question1`}></input><label htmlFor="question1">Check if correct</label><br />
