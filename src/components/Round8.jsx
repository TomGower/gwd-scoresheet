...
const RandomRound = ({
  ...
  return (
    <div>
      ...
      <Question thisColor={holder.q8} round={info.round} answer={info.answers[7]} number={5} />
      ...
      <Question thisColor={holder.q12} round={info.round} answer={info.answers[11]} number={7} />
